...
<template>
    <div class="p-8 pb-0 text-orange-500">
        <h1 class="text-4x1 font-bold mb-4"> Search Meals By ingredients</h1>
    </div>

    <!-- {{ ingredients }} -->

    <div class="p-10">
        <input type="text" v-model="keyword" class="rounded border-gray-200 w-full bg-white mb-5" placeholder="Enter ingredient name" />
